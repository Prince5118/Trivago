...
def get_popularity_and_information(df, df_meta):
    ...
    # df_expl -> user_id, session_id, timestamp, step, action_type, reference, platform, city, device, current_filters, prices, impressions
...
def calc_recommendation(df_expl, df_pop):
    ...
    df_expl_clicks = df_expl_clicks.fillna(0)
